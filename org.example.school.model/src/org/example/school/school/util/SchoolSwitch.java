...
public class SchoolSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SchoolPackage.SCHOOL_MODEL: {
			...
			case SchoolPackage.SCHOOL: {
				...
				if (result == null) result = caseNamed(school);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchoolPackage.NAMED: {
			...
			case SchoolPackage.STUDENT: {
				...
				if (result == null) result = caseNamed(student);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchoolPackage.TEACHER: {
				...
				if (result == null) result = caseNamed(teacher);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
